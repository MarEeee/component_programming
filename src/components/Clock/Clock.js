...
const Clock = () => {
    ...
    return(
    <svg  width="100%" height="100%" viewBox="0 0 1280 1280" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx = "640" cy = "640" r = "30" fill="black" />
        <rect x="627.5" y="240" width="25" height="400" fill = "black" style={{transformOrigin: "640px 640px", transform: `rotate(${data.hour}deg)`}} />
        <rect x="632.5" y="140" width="15" height="500" fill = "black" style={{transformOrigin: "640px 640px", transform: `rotate(${data.minutes}deg)`}} />
        <rect x="632.5" y="140" width="7" height="500" fill = "black" style={{transformOrigin: "640px 640px", transform: `rotate(${data.seconds}deg)`}} />
    </svg>
    )
}
